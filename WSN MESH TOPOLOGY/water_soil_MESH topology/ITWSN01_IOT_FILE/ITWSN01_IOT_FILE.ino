...
Adafruit_MQTT_Publish NODE1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/node1");
Adafruit_MQTT_Publish NODE2 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/node2");
Adafruit_MQTT_Publish NODE3 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/node3");
