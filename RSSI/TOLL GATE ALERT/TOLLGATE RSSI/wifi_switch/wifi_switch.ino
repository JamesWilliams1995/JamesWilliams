...
void loop()
{
  ...
  client.println("TOLL GATE");
  client.println("<br>"); client.println("<br>"); client.println("<br>"); client.println("<br>");
  client.println("<hr color=yellow width= 100%>");
  ////////////////////////////////////////////////////////////////////////////

  client.println("<h1 style=color:#4A213A    ;>TOLL GATE RANGE</h1>");
  client.println("<br>"); client.println("<br>");
  if ((rssi <= 40 && rssi != 0)) // if rssi is greater then -70 dbm or it's 0 dbm, then the light will turn ON
  {
    ss.print('A');
    Serial.print("as");
    ...
    client.println("TOLL GATE ENTRY"); client.println("</tr>");
  ...
  if (rssi <= 60 && rssi >= 41)
  {
    ...
    client.println("TOLL GATE AMOUNT"); client.println("</tr>");
  ...
  if (rssi >= 61 )
  {
    ...
    client.println(rssi); client.println("<tr>");
    client.println("<td colspan=2>");
    client.println("TOLL GATE NEAR"); client.println("</td>"); client.println("</tr>");
