...
void loop()
{
  if ((millis() - oldTime) > 1000)   // Only process counters once per second
  {
    ...
    {
      Serial.write('B');
      gsm("9384650825", "METHANE DETECTED");
    }
    lcd.print("F:");
...
void temperature(void)
{
  ...
  {
    Serial.write('A');
    gsm("9384650825", "HIGH TEMPERATURE");
  }
}
