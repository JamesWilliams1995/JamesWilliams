...
Adafruit_MQTT_Publish hb1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/amount");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (strcmp((char *)mode0.lastread, "8") == 0) {
      Serial.println("8");
      ss.write('8');
    }

    if (strcmp((char *)mode0.lastread, "Q") == 0) {
      Serial.println("Q");
      ss.write('Q');
    }
    if (strcmp((char *)mode0.lastread, "#") == 0) {
      Serial.println("#");
      ss.write('#');
    }
