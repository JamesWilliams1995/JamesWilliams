...
Adafruit_MQTT_Publish hb1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/light1");
Adafruit_MQTT_Publish spo21 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/fan1");
Adafruit_MQTT_Publish speed1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/plug1");

Adafruit_MQTT_Subscribe LIGHT = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/LIGHT");
Adafruit_MQTT_Subscribe FAN = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/FAN");
Adafruit_MQTT_Subscribe PLUG = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/PLUG");
...
//  }
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (strcmp((char *)LIGHT.lastread, "2") == 0) {
      Serial.println("LIGHT OFF");
      ss.write('2');
    }
    if (strcmp((char *)FAN.lastread, "3") == 0) {
      Serial.println("FAN ON");
      ss.write('3');
    }
    if (strcmp((char *)FAN.lastread, "4") == 0) {
      Serial.println("FAN OFF");
      ss.write('4');
    }
    if (strcmp((char *)PLUG.lastread, "5") == 0) {
      Serial.println("PLUG ON");
      ss.write('5');
    }
    if (strcmp((char *)PLUG.lastread, "6") == 0) {
