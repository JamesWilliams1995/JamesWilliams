...
#define AIO_USERNAME    "M0857M0857"
#define AIO_KEY         " "
...
Adafruit_MQTT_Publish hb1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/TempF");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &mode0) {
      ...
      if (strcmp((char *)mode0.lastread, "5") == 0) {
        Serial.println("mode3");
        ss.write('5');
      }
    }
