...
class ZephyrFlowRateSensor
{
  public:
    ...
    */
    /**************************************************************************/
    ZephyrFlowRateSensor(const uint8_t address, const float range, const SensorType type = SLPM)
    ...
    */
    /**************************************************************************/
  float flow() const { return _type == SLPM ? 
                                _FLOW_RANGE * ( ( (float)_count/16384.0) - 0.1) * 1.2:
